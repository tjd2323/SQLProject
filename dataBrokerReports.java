...
GetAppointments(IN myCat char(200), IN country char(50), IN city char(50), IN startTime timestamp, IN endTime timestamp, out numappt int, out numCompleted int, out numCanceled int, out numNoShow int)
