...
TRUNCATE TABLE Appointment_Has_Message;
TRUNCATE TABLE Reviews;
TRUNCATE TABLE Verification;
TRUNCATE TABLE Reminder;
TRUNCATE TABLE Appointment;
TRUNCATE TABLE Service;
TRUNCATE TABLE Availability_block;
TRUNCATE TABLE DataBroker_Profile;
TRUNCATE TABLE Buisness_Report;
TRUNCATE TABLE Buisness_Profile;
TRUNCATE TABLE Message;
TRUNCATE TABLE Generic_Account;
...
insert into Generic_Account(Account_type, full_name, address, city, country, email, phone)   values ('C', 'Tyler Dean', '4210 Rotal Manor Drive', 'Houston', 'USA', 'someEmail@yahoo.com', '123-456-7890');
    ...
    insert into Appointment(account_id, service_id, notes, appt_status, no_show, startTime, endTime, cancel_window_min) values (1,  7, 'Buying a cat',  'completed', false,  '2023-09-16 14:00:00', '2023-09-16 16:00:00', 1200);
...
SELECT 'Generic_Account' Tables, COUNT(*) Tuples FROM Generic_Account
UNION ALL SELECT 'Buisness_Profile', COUNT(*) FROM Buisness_Profile
UNION ALL SELECT 'DataBroker_Profile', COUNT(*) FROM DataBroker_Profile
...
UNION ALL SELECT 'Appointment_Has_Message', COUNT(*) FROM Appointment_Has_Message
UNION ALL SELECT 'Availability_block', COUNT(*) FROM Availability_block
UNION ALL SELECT 'Buisness_Report', COUNT(*) FROM Buisness_Report;
